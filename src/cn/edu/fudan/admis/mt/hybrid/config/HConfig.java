package cn.edu.fudan.admis.mt.hybrid.config;
...
public class HConfig
{
	...
	public static double[] PercentWH = { 0.4, 0.6 }; // 0.4 for write heavy and
														// 0.6 for read heavy
	public static double[] PercentTenantSplits = { 0.06 // QT: 20, DS: 3, write
														// heavy
	...
	public static int QTMatrix[] = { ValueQT[0], ValueQT[0], ValueQT[0],
			ValueQT[0], ValueQT[0], ValueQT[0], ValueQT[1], ValueQT[1],
			ValueQT[1], ValueQT[1], ValueQT[1], ValueQT[1], ValueQT[2],
			ValueQT[2], ValueQT[2], ValueQT[2], ValueQT[2], ValueQT[2], };
	public static double DSMatrix[] = { ValueDS[0], ValueDS[0], ValueDS[1],
			ValueDS[1], ValueDS[2], ValueDS[2], ValueDS[0], ValueDS[0],
			ValueDS[1], ValueDS[1], ValueDS[2], ValueDS[2], ValueDS[0],
			ValueDS[0], ValueDS[1], ValueDS[1], ValueDS[2], ValueDS[2] };
	public static boolean WHMatrix[] = { true, false, true, false, true, false,
	...
	public static void init(int n)
	{
		...
		{
			if (i == 0)
				PercentTenantSplitsSum[i] = PercentTenantSplits[0];
			else
				PercentTenantSplitsSum[i] = PercentTenantSplitsSum[i - 1]
						+ PercentTenantSplits[i];
	 ...
	 * @param tenantId
	 * @param isType
	 *            , true if tenantId represents TYPE; false if tenantId
	 *            represents tenant id
	 * @return
	 */
